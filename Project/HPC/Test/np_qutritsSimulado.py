...
num_particles = 4  # asegúrate de que está definido aquí
...
def encode_1p1q_qutrit(jets, w, unitaries):
    ...
    for i in range(num_particles):
        ...
        initial_state = inicializing_qutrit_state( theta, phi, tau12, energy)
...
for i in range(100):
    ...
    fidelidades = []
    etiquetas = []
    print("Fin de entranmeinto, empezamos inferencia")
...
print("Guardado como np_qutrits_tau12E.npz")
